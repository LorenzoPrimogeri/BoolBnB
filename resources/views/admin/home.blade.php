...
<body>
    <nav class="navbar navbar-expand-md flex-md-nowrap mb-4 p-0">
        <div class="cnt-logo">
            ...
            <nav class="col-sd-2 col-md-2 d-md-block  sidebar py-4 nav-sidebar-home">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item  ">
                            <a class="nav-link active text-left d-flex align-items-center  " href="{{ route('admin.apartments.index') }}">
