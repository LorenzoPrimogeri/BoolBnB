...
@section('content')
    ...
    <form action="{{route('admin.apartments.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <input class="w-100 p-1" type="text" name="title" placeholder="Inserisci il t value="{{old('title')}}" required>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <h5 class="pt-2">Descrizione</h5>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <textarea name="description" class="w-100" rows="10" placeholder="Inserisci una descri value="{{old('description')}}" required></textarea>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <h5 class="pt-2">Stanze</h5>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <input class="w-100 p-1" type="number" name="room" placeholder="Inserisci il numero di s value="{{old('room')}}" required>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <h5 class="pt-2">letti</h5>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <input class="w-100 p-1" type="number" name="bed" placeholder="Inserisci il numero di  value="{{old('bed')}}" required>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <h5 class="pt-2">bagni</h5>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <input class="w-100 p-1" type="number" name="bathroom" placeholder="Inserisci il numero di  value="{{old('bathroom')}}" required>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <h5 class="pt-2">Metri quadri</h5>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <input class="w-100 p-1" type="number" name="mq" placeholder="Inserisci il numero di q value="{{old('mq')}}" required>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <h5 class="pt-2">Indirizzo</h5>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <input class="w-100 p-1" type="text" name="address" placeholder="Inserisci l'indi value="{{old('address')}}" required>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
            ...
            <div class="col-12 flex-dr-col algn-itm-init b-0">
                <input class="w-100 p-1" type="text" name="price" placeholder="Inserisci il p value="{{old('price')}}" required>
            </div>
            <div class="col-12 flex-dr-col algn-itm-init b-0">
