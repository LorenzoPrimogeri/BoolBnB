            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="profile_img" class="col-md-4 col-form-label text-md-right">{{
                                __('Stringa')
                                }}</label>

                            <div class="col-md-6">
                                <input id="profile_img" type="text"
                                    class="form-control @error('profile_img') is-invalid @enderror" name="profile_img"
                                    value="{{ old('profile_img') }}" required autocomplete="profile_img" autofocus>
